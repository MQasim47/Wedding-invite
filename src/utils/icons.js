...
export const icons = {
  ...
  grill: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.5"><path d="M5 12a7 7 0 1014 0"/><line x1="5" y1="12" x2="19" y2="12"/><path d="M9 12V8M12 12V6M15 12V8"/><path d="M8 21l1-5M16 21l-1-5"/></svg>`,
  ...
  alert: `<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><circle cx="12" cy="12" r="9.5"/><path d="M12 7.5v5.5M12 16.4v.2"/></svg>`,
